...
def custom_step(
    ...
    if eta > 0:
        ...
        ### Added ###
        prev_sample_no_noise = prev_sample.clone()
        prev_sample = prev_sample + variance
    
    else:
        prev_sample_no_noise = prev_sample

    if not return_dict:
        return (prev_sample, pred_original_sample), prev_sample_no_noise
...
def mystep(
    ...
    return DDIMSchedulerOutput(prev_sample=prev_sample, pred_original_sample=pred_original_sample), prev_sample_no_noise 
