...
from .latte_t2v import PixArt_alpha
...
def get_models(args):
    if 'LatteIMG' in args.model:
        ...
        return PixArt_alpha.from_pretrained(args.pretrained_model_path, subfolder="transformer", video_length=args.video_length)
